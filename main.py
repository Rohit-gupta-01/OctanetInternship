...
class Bank(Frame):
    ...
    def main(self):
        ...
        Label(self,text = "Welcome to Ravindra Bank",fg = "black",
              relief = RAISED,bg = "green",borderwidth = 10,height = 2,padx = 3,pady = 3,
              width = 46,font = "Calibri").grid()
        
        Button(self,text = "Admin",bg = "pink",fg = "blue",width = 40,
               height = 2,command = self.AdminStart,activeforeground = "red").grid(sticky = W+S,pady = 10,padx = 5)
        
        Button(self,text = "User",bg = "pink",fg = "blue",width = 40,
